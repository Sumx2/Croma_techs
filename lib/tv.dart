...
//
// class _TelevisionPageState extends State<TelevisionPage> {
//   List<bool> isLiked = List.filled(8, false); // Initialize a list to track like status for each item
//
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
...
//                 mainAxisSpacing: 4.0,
//               ),
//               itemCount: 8, // Update the itemCount to accommodate additional images
//               itemBuilder: (context, index) {
...
//                                 });
//                                 if (isLiked[index]) {
//                                   // Pass the liked image URL to the WishlistPage
//                                   Navigator.push(
//                                     context,
//                                     MaterialPageRoute(
//                                       builder: (context) => WishlistPage(imageUrl: imageUrls[index]),
//                                     ),
//                                   );
//                                 }
//                               },
...
//
//   WishlistPage({required this.imageUrl});
//
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
...
//             ElevatedButton(
//               onPressed: () {
//                 // Add functionality to navigate to the previous page
...
//         onPressed: () {
//           // Navigate to the WishlistPage when the FAB is pressed
//           Navigator.push(
//             context,
//             MaterialPageRoute(
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => WishlistPage(
                wishlistItems: List.generate(imageUrls.length, (index) => WishlistItem(imagePath: imageUrls[index])),
              ),
            ),
          );
        },
